...
public class WeatherDaoImpl implements WeatherDao {
    private static Session session = HibernateConfigTemp.getSessionFactory().openSession();
    ...
    private  <T> Criteria buildCriteria(Class<T> clazz, Map<String, Object> criterias)  {
